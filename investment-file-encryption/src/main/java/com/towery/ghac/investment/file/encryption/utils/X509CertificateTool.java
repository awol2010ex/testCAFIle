...
public class X509CertificateTool {
    ...
    public static void main(String args[]) {
        new File("E:/ca-root/jk_smcg/").mkdirs();
        ...
        tool.writeKeyToPemFile((Key) caprivateKey, new File("E:/ca-root/ca-private.pem"));
        X509Certificate caCert = new X509CertificateTool().generateCaRootCertificate((PublicKey) capublicKey, (PrivateKey) caprivateKey);
        new X509CertificateTool().writeCertificateToPemFile(caCert, new File("E:/ca-root/ca-cert.cert"));
